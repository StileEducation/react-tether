...
var childrenPropType = function childrenPropType(
  _ref,
  propName,
  componentName
) {
...
var TetherComponent = (function(_Component) {
  ...
  function TetherComponent(props) {
    ...
    var _this = _possibleConstructorReturn(
      this,
      (
        TetherComponent.__proto__ || Object.getPrototypeOf(TetherComponent)
      ).call(this, props)
    );
  ...
  _createClass(TetherComponent, [
      ...
      value: function _registerEventListeners() {
        ...
        this.on('update', function() {
          return (
            ...
            _this2.props.onUpdate.apply(_this2, _arguments)
          );
        });

        this.on('repositioned', function() {
          return (
            _this2.props.onRepositioned &&
            _this2.props.onRepositioned.apply(_this2, _arguments)
          );
        });
      },
    },
    ...
    },
    {
      ...
      value: function _updateTether() {
        ...
        var _props = this.props,
          ...
          style = _props.style,
          options = _objectWithoutProperties(_props, [
            'children',
            'renderElementTag',
            'renderElementTo',
            'id',
    ...
    },
    {
      ...
      value: function render() {
        ...
        return [
          _react.Children.toArray(children)[0],
